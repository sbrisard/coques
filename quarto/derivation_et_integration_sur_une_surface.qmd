...
On peut montrer que les vecteurs $\vec{a}^\xi$, $\vec{a}^\eta$ et $\vec{n}$ sont **linéairement indépendants** et forment une base, nommée **base duale de la base locale naturelle**.
